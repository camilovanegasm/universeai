...
export default function BotonGoogle({ onClick, deshabilitado, texto }: Props) {
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      <svg width="20" height="20" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path
          fill="#FF3D00"
          d="M6.3 14.7l6.6 4.8C14.7 16 19 13 24 13c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.1 29.5 4 24 4c-7.4 0-13.8 4.2-17 10.3z"
        />
        <path
          fill="#4CAF50"
          d="M24 44c5.4 0 10.3-2.1 14-5.4l-6.5-5.5c-2 1.5-4.6 2.4-7.5 2.4-5.2 0-9.6-3.3-11.3-8l-6.6 5.1C9.9 39.6 16.4 44 24 44z"
        />
        <path
          fill="#1976D2"
